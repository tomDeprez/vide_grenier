...
?>
    ...
    <body>
        ...
        try {
            ...
            $update_vg =  "UPDATE videgrenier SET DATE_VG = :date_vg, NBREEMPLINIT_VG = :nbr, NBREEMPLINDISPO_VG = :restant, PRIXEMPL_VG = :prix WHERE ID_VG = :id_vg";
...
//            $addresse = htmlspecialchars($_POST['addresse']);
            ...
            if($id_vg == "" || $date == "" || $nombre == "" || $restant == "" || $prix == "" ){
